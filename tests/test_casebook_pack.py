"""Regression checks for the meridian-chain-mempool-lab casebook."""
...
from casebook.harness import assert_expected, meridian_chain_mempool_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_chain_mempool_lab_summary(), assert_expected())
